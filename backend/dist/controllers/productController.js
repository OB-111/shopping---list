...
exports.getSavedProducts = exports.deleteProduct = exports.updateShoppingList = exports.addOrUpdateProducts = void 0;
...
const addOrUpdateProducts = async (req, res) => {
    ...
    try {
        for (const product of products) {
            ...
            const existingProduct = await models_1.Product.findOne({ where: { name, category } });
            if (existingProduct) {
...
const deleteProduct = async (req, res) => {
    ...
    try {
        const result = await models_1.Product.destroy({ where: { name, category } });
        if (result) {
